...
python main.py --feature_channels $feature_channels --trial_run $trial_run --dataset $dataset --epoch $epoch --seed $seed --T $T --image_size $image_size --if_small_dataset $if_small_dataset --lr1 $lr1 --lr2 $lr2 --lr3 $lr3 --bs $bs --dr $dr --log_dir $log_dir
